                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            <div class="profile-pic text-center">
                                                <img alt="User Pic" src="{{asset('uploads/images.png')}}" id="profile-image1" style="width: 210px;object-fit: cover;height: 230px;border: 2px solid #d1d1d1;">
                                                <input id="profile-image-upload" class="hidden" style="visibility: hidden;" type="file" onchange="previewFile()" name="student_pic">
                                                <div style="color:#999;" >  </div>
                                            </div>
                                            @if ($errors->has('stdnt_pic'))  
                                                {!! "<span class='span_danger'>". $errors->first('stdnt_pic')."</span>"!!} 
                                            @endif
                                        </div>
                                    </div>
                                </div>
