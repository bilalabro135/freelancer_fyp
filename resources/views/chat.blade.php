    ...
    <div class="page-inner">
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header text-center">
                <h4 class="modal-title w-100 font-weight-bold">Pay them</h4>
                        ...
                        <div class="container">
                          <div id="Checkout" class="inline">
                              ...
                              <div class="form-group">
                                  ...
                                  <input required id="CreditCardNumber" class="null card-image form-control" type="text"></input>
                              </div>
                              <div class="expiry-date-group form-group">
                                  <label for="ExpiryDate">Expiry date</label>
                                  <input required id="ExpiryDate" class="form-control" type="text" placeholder="MM / YY" maxlength="7"></input>
                              </div>
                              <div class="security-code-group form-group">
                                  <label for="SecurityCode">Security code</label>
                                  <div class="input-container" >
                                      <input required id="SecurityCode" class="form-control" type="text" ></input>
                              ...
                              <div class="zip-code-group form-group">
                                  ...
                                  <div class="input-container">
                                      <input required id="ZIPCode" class="form-control" type="text" maxlength="10"></input>
                                      <a tabindex="0" role="button" data-toggle="popover" data-trigger="focus" data-placement="left" data-content="Enter the ZIP/Postal code for your credit card billing address."><i class="fa fa-question-circle"></i></a>
                                  </div>
                              </div>
                              <button id="PayButton" class="btn btn-block btn-success submit-button" type="submit">
                                  <span class="submit-button-lock"></span>
                                  <span class="align-middle">Pay PKR {{$project->price ?? ''}}</span>
                              </button>
                          </div>
                        </div>
                    </div>
        ...
        <div class="page-header d-flex justify-content-between">
            ...
            @if((Auth::user()->roles[0]->id == 4))
                <a href="#" class="mr-3 btn btn-primary request-completion-btn" data-toggle="modal" data-target="#modalLoginForm">Pay Now</a>
            @endif
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header bg-primary">
                        <div class="d-flex align-items-center">
                            ...
                            <a  href="{{ route('chats') }}" class="btn btn-primary btn-xs ml-auto">
                ...
                <script>
                                        ...
                                        switch (fileExtension) {
                                            ...
                                            case 'gif':
                                                $('#filePreviewContainer').append($('<img>', {
                                                    src: e.target.result,
                                                    style: 'width: 100%; border-radius: 100px; height: 110px; max-width: 110px; margin: 10px 10px; object-fit: cover;'
                                                }));
                                                break;
                                            default:
                                                $('#filePreviewContainer').append($('<span>', {
                                                    text: 'Preview not available for file type: ' + fileExtension,
                    ...
                    function shouldAutoScroll() {
                        var chatBox = $('#chatBox');
                        var threshold = 100; // pixels from the bottom
                        return (chatBox[0].scrollHeight - chatBox.scrollTop() - chatBox.outerHeight()) < threshold;
                    }
                    ...
                    function fetchMessages() {
                        ...
                        $.ajax({
                            type: 'GET',
                            url: '{{ route("fetch.messages", ["userId" => $user->id]) }}',
                            success: function(data) {
                                ...
                                $.each(data, function(index, message) {
                                    ...
                                    messageContent += '<span class="badge badge-primary" style="font-size: 14px;">'+ (message.project_name || '') +'</span>&nbsp;<div class="message-sequence"><p class="m-0">' + (message.message || '') + '</p></div>';
                                    if (message.file_path) {
                                        try {
                                            var filePaths = JSON.parse(message.file_path);
                                            if (filePaths.length) {
                                                filePaths.forEach(function(filePath) {
                                                    ...
                                                    switch (fileExtension) {
                                                        ...
                                                        case 'png':
                                                        case 'gif':
                                                            messageContent += '<img src="' + fullPath + '" width="150px" height="auto" style="background-color: #f7f7f7;padding: 20px 20px;border-radius: 10px;margin-bottom: 20px;">';
                                                            break;
                                                        case 'pdf':
                                                        case 'doc':
                                                        case 'docx':
                                                        case 'xls':
                                                        case 'xlsx':
                                                            messageContent += '<a href="' + fullPath + '" target="_blank" style="display: block; margin: 10px;">Open ' + fileExtension.toUpperCase() + ' File</a>';
                                                            break;
                                                    }
                                                });
                                            }
