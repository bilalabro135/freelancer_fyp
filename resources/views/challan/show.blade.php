                ...
                <div class="card">
                    ...
                    <div class="card-header bg-success">
                        <div class="d-flex align-items-center justify-content-center">
                            <h4 class="card-title text-light">Fee Statement</h4>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                                    ...
                                    <table class="table dt-responsive table-two">
                                        <tbody>
                                            ...
                                            @foreach($challans as $key => $challan)
                                                <tr style="border-top: 1px solid #ebedf2;">
                                                    <td width="35%">{{date(date('m - y'),strtotime($challan->created_at))}}</td>
                                                    <td>
                                                        @if($challan->monthly_fee)
                                                            {{$challan->monthly_fee}}
                                                        @else
                                                            -
                                                        @endif
                            ...
                            {{  Form::hidden('action', "store" ) }}
                                ...
                                <div class="card-body">
                                    <div class=" row">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                            <div class="form-group">
                                                {!! Html::decode(Form::label('fees_pay','Admission Fee')) !!}
